...
void display() {
    ...
    mat4 cameraRotate = camera.GetViewMatrix();  // 相机注视着原点
...
GLFWwindow* Init()
{
    ...
    GLFWwindow* window = glfwCreateWindow(512, 512, "openglRT", NULL, NULL);
...
int main(int argc, char** argv) {
 ...
 // scene config
    ...
    Material m;
    m.baseColor = vec3(1.0f, 0.0f, 0.0f);
...
// 管线配置
    ...
    pass1.program = getShaderProgram("shader/fshader.frag", "shader/vshader.vert");
    ...
    pass2.program = getShaderProgram("shader/pass2.frag", "shader/vshader.vert");
    lastFrame = getTextureRGB32F(pass2.width, pass2.height);
    pass2.colorAttachments.push_back(lastFrame);
    pass2.bindData();

    pass3.program = getShaderProgram("shader/pass3.frag", "shader/vshader.vert");
    pass3.bindData(true);
